...
! function (a) {
  ...
  b.DEFAULTS = {
    initOnClick: !1,
    pluginsEnabled: null
  }, b.MODULES = {}, b.PLUGINS = {}, b.VERSION = "2.1.1", b.INSTANCES = [], b.ID = 0, b.prototype._init = function () {
    ...
    function e(e, f) {
      ...
      if (e.querySelectorAll(a.FroalaEditor.VOID_ELEMENTS.join(",")).length - e.querySelectorAll("br").length) return !1;
      if (e.querySelectorAll(b.opts.htmlAllowedEmptyTags.join(",")).length) return !1;
      if (e.querySelectorAll(a.FroalaEditor.BLOCK_TAGS.join(",")).length > 1) return !1;
      ...
      for (var h = !1, i = 0; i < g.length; i++) {
        ...
        if (!(f && a(j).hasClass("fr-marker") || j.nodeType == Node.TEXT_NODE && 0 == j.textContent.length)) {
          if ("BR" != j.tagName && (j.textContent || "").replace(/\u200B/gi, "").length > 0) return !1;
          if (h) return !1;
          "BR" == j.tagName && (h = !0)
        }
      }
    ...
    function n(b) {
      return b && b.nodeType == Node.ELEMENT_NODE && a.FroalaEditor.VOID_ELEMENTS.indexOf((b.tagName || "").toLowerCase()) >= 0
    }
    ...
    function r() {
      ...
      b.$el.find("table").filter(function () {
        ...
        return !a || b.node.isBlock(a) || "BR" == a.tagName || a.nodeType != Node.TEXT_NODE && a.nodeType != Node.ELEMENT_NODE ? !1 : !0
      }).before("<br>");
    ...
    function d() {
      ...
      if (c() > 0) a.msie = !0;
        ...
        d[1] && (a[e.browser] = !0), a.msie && (a.version = parseInt(e.version, 10)), a.chrome ? a.webkit = !0 : a.webkit && (a.safari = !0)
      }
      return a
    }
    ...
    function h() {
      c(b.$document, "dragend drop", function (a) {
        s("document." + a.type, [a])
      })
    }
    ...
    function g(a) {
      ...
      if ("undefined" != typeof b.document.caretPositionFromPoint ? (f = b.document.caretPositionFromPoint(c, d), g = b.document.createRange(), g.setStart(f.offsetNode, f.offset), g.setEnd(f.offsetNode, f.offset)) : "undefined" != typeof b.document.caretRangeFromPoint && (f = b.document.caretRangeFromPoint(c, d), g = b.document.createRange(), g.setStart(f.startContainer, f.startOffset), g.setEnd(f.startContainer, f.startOffset)), null !== g && "undefined" != typeof b.window.getSelection) {
        ...
        g = b.document.body.createTextRange(), g.moveToPoint(c, d);
        var j = g.duplicate();
      ...
      if (c)
        for (d = b.$el.find(f()), g = 0; g < d.length; g++) {
          for (var i = b.node.contents(d[g]), j = !1, k = 0; k < i.length; k++)
            if (i[k].nodeType != Node.COMMENT_NODE && (i[k].nodeType == Node.ELEMENT_NODE && (a.FroalaEditor.VOID_ELEMENTS.indexOf(i[k].tagName.toLowerCase()) >= 0 || i[k].querySelectorAll(b.opts.htmlAllowedEmptyTags.join(",")).length > 0) || i[k].textContent && i[k].textContent.replace(/\u200B/g, "").length > 0)) {
              j = !0;
              break
            }
    ...
    function h(d, e) {
      ...
      if (e && (f = 'div class="fr-temp-div"'), f)
        for (var g = b.node.contents(d.get(0)), h = null, i = 0; i < g.length; i++) {
          var j = g[i];
          if (j.nodeType == Node.ELEMENT_NODE && (b.node.isBlock(j) || a(j).is(b.opts.htmlDoNotWrapTags.join(",")))) h = null;
    ...
    function u() {
      b.core.isEmpty() && (null != c() ? 0 === b.$el.find(f()).length && 0 == b.$el.find(b.opts.htmlDoNotWrapTags.join(",")).length && (b.core.hasFocus() ? (b.$el.html("<" + c() + ">" + a.FroalaEditor.MARKERS + "<br/></" + c() + ">"), b.selection.restore()) : b.$el.html("<" + c() + "><br/></" + c() + ">")) : 0 === b.$el.find("*:not(.fr-marker):not(br)").length && (b.core.hasFocus() ? (b.$el.html(a.FroalaEditor.MARKERS + "<br/>"), b.selection.restore()) : b.$el.html("<br/>")))
    }
              ...
              if (i[l].selectorText && 0 === i[l].selectorText.indexOf(n) && i[l].style.cssText.length > 0)
                for (var o = i[l].selectorText.replace(n, "").replace(/::/g, ":"), p = b.$el.get(0).querySelectorAll(o), q = 0; q < p.length; q++) {
                  ...
                  for (var r = 1e3 * j + f(i[l].selectorText), t = i[l].style.cssText.split(";"), u = 0; u < t.length; u++) {
                    ...
                    h[p[q]][v] || (h[p[q]][v] = 0, (p[q].getAttribute("fr-original-style") || "").indexOf(v + ":") >= 0 && (h[p[q]][v] = 1e4)), r >= h[p[q]][v] && (h[p[q]][v] = r, p[q].setAttribute("style", (p[q].getAttribute("style") || "") + t[u] + ";"))
                  }
                }
            }
        }
        for (e = 0; e < g.length; e++) {
          g[e].getAttribute("class") && (g[e].setAttribute("fr-original-class", g[e].getAttribute("class")), g[e].removeAttribute("class"));
          var w = g[e].getAttribute("style");
          w && g[e].setAttribute("style", w.split(";").sort(function (a, b) {
            return a = a.split(":")[0], b = b.split(":")[0], "" == a || "" == b ? -1 : a.localeCompare(b)
          }).join("; ").trim())
        }
      }
    ...
    function E(c, d, e) {
      ...
      if (f = d ? c : b.clean.html(c), f = f.replace(/\r|\n/g, " "), c.indexOf('class="fr-marker"') < 0 && (f = C(f)), b.core.isEmpty()) b.$el.html(f);
        ...
        b.markers.insert();
        var g, h = b.$el.find(".fr-marker").get(0);
        if ((B(f) || e) && (g = b.node.deepestParent(h))) {
          var h = b.markers.split();
          if (!h) return !1;
          a(h).replaceWith(f)
        }
        else a(h).replaceWith(f)
      }
    ...
    function j() {
      return b.node.hasFocus(b.$el.get(0)) || b.$el.find("*:focus").length > 0
    }
  ...
  }, a.FroalaEditor.NO_DELETE_TAGS = ["TH", "TD", "TABLE", "FORM"], a.FroalaEditor.SIMPLE_ENTER_TAGS = ["TH", "TD", "LI", "DL", "DT", "FORM"], a.FroalaEditor.MODULES.cursor = function (b) {
    function c(a) {
        ...
        if (b.node.isBlock(e) && b.node.isEditable(e) && h && a.FroalaEditor.NO_DELETE_TAGS.indexOf(h.tagName) < 0 && b.node.isEditable(h))
          if (b.node.isBlock(h))
            if (b.node.isEmpty(h) && !b.node.isList(h)) a(h).remove();
              ...
              a(c).replaceWith(a.FroalaEditor.MARKERS), a(h).append(b.node.isEmpty(e) ? a.FroalaEditor.MARKERS : e.innerHTML), a(e).remove()
            }
    ...
    function q(c, d, g) {
      var h = b.node.deepestParent(c, [], !g);
      if (null == h) b.html.defaultTag() && c.parentNode === b.$el.get(0) ? a(c).replaceWith("<" + b.html.defaultTag() + ">" + a.FroalaEditor.MARKERS + "<br></" + b.html.defaultTag() + ">") : ((!c.nextSibling || b.node.isBlock(c.nextSibling)) && a(c).after("<br>"), a(c).replaceWith("<br>" + a.FroalaEditor.MARKERS));
      else {
        var i = c,
          j = "";
    ...
    function d(c, d) {
      ...
      b.$tooltip.css("left", e), b.$tooltip.css("top", f)
    }
    ...
    function j(c, d) {
      ...
      a(j).on(b._mouseup + ".command" + b.id + " resize.command" + b.id + " keydown.command" + b.id, k), b.opts.iframe && b.$window.on(b._mouseup + ".command" + b.id, k), a.merge(q, c.find(".fr-btn").toArray()), b.tooltip.bind(c, ".fr-btn, .fr-title", d), b.events.on("destroy", function () {
        c.off(b._mousedown + " " + b._mouseup + " " + b._move, ".fr-dropdown-menu"), c.on(b._mousedown + " " + b._mouseup + " " + b._move, ".fr-dropdown-menu .fr-dropdown-wrapper"), a(j).off(b._mouseup + ".command" + b.id + " resize.command" + b.id + " keydown.command" + b.id), b.$window.off(b._mouseup + ".command" + b.id)
      }, !0)
    }
  ...
  a.FroalaEditor.MODULES.toolbar = function (b) {
    ...
    function g() {
      a(b.original_window).on("resize.buttons." + b.id, f),
      a(b.original_window).on("orientationchange.buttons." + b.id, f)
    }
    ...
    function m() {
      b.$tb.addClass("mui-panel");
      b.$tb.addClass("mui-panel-fucked");

      document.querySelector('#toolbarClone').innerHTML = '<div class="fr-toolbarz fr-toolbar">';

      b.opts.toolbarInline ? (
        b.$box.addClass("fr-inline"),
        b.helpers.isMobile() ? (b.helpers.isIOS() ? ( a(b.opts.scrollableContainer).prepend(b.$tb), b.position.addSticky(b.$tb)) : (b.$tb.addClass("fr-bottom"),
        b.$box.append(b.$tb),
        // $(document.body).append(b.$tb),
    ...
    function o() {
      return b.$wp ? (
          b.$tb = $( document.querySelector('.fr-toolbarz.fr-toolbar') ),
          ...
          m(),
          // r = b.$tb.get(0).ownerDocument,
          r = document ,
          s = "defaultView" in r ? r.defaultView : r.parentWindow,
          d(),
          g(),
          b.$tb.on(b._mousedown + " " + b._mouseup,
          function (a) {
            var b = a.originalEvent ? a.originalEvent.target || a.originalEvent.originalTarget : null;
            return b && "INPUT" != b.tagName ? (a.stopPropagation(), a.preventDefault(), !1) : void 0
          }),
    ...
    t[a.FroalaEditor.XS] = b.opts.toolbarButtonsXS || b.opts.toolbarButtons,
    t[a.FroalaEditor.SM] = b.opts.toolbarButtonsSM || b.opts.toolbarButtons,
    t[a.FroalaEditor.MD] = b.opts.toolbarButtonsMD || b.opts.toolbarButtons,
    t[a.FroalaEditor.LG] = b.opts.toolbarButtons;
    ...
    function c(c) {
      ...
      if (b.keys.ctrlKey(c) && (c.shiftKey && a.FroalaEditor.SHORTCUTS_MAP[-d] || !c.shiftKey && a.FroalaEditor.SHORTCUTS_MAP[d])) {
        ...
        if (e && b.opts.shortcutsEnabled.indexOf(e) >= 0) {
          ...
          if (e && !g ? f = b.$tb.find('.fr-command[data-cmd="' + e + '"]') : e && g && (f = b.$tb.find('.fr-command[data-cmd="' + e + '"][data-param1="' + g + '"]')), f.length) return c.preventDefault(), c.stopPropagation(), "keydown" == c.type && b.button.exec(f), !1;
    ...
    a.extend(a.FroalaEditor.POPUP_TEMPLATES, {
      ...
      , callback: function () {
        if( this.popups.isVisible("table.insert") ){
          (this.$el.find(".fr-marker") && (this.events.disableBlur(), this.selection.restore()), this.popups.hide("table.insert"));
        } else {
