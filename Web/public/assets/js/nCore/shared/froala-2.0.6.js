  ...
  b.DEFAULTS = {
    ...
    var b = this.$original_element.prop("tagName")
      ...
      this.$el = this.$original_element, this.$el.attr("contenteditable", !0)
        .css("outline", "none"), this.opts.multiLine = !1, this.opts.toolbarInline = !1, this.$original_element.trigger("froala.doInit")
    }, this)
      , f = a.proxy(function () {
    ...
    function cleanEmptyTags() {
      ...
      var d, e;
      do {
        e = !1, d = b.$el.find("*:empty")
          .not(c.join(", ") + ", .fr-marker");
    ...
    function get(a, c) {
          ...
          if (g)
            for (var i = 0, j = g.length; j > i; i++) {
              ...
              if (g[i].selectorText && 0 === g[i].selectorText.indexOf(k) && g[i].style.cssText.length > 0)
                for (var l = g[i].selectorText.replace(k, "")
                  .replace(/::/g, ":"), m = b.$el.get(0)
                  .querySelectorAll(l), n = 0; n < m.length; n++) {
                  !m[n].getAttribute("fr-original-style") && m[n].getAttribute("style") && (m[n].setAttribute("fr-original-style", m[n].getAttribute("style")), f.push(m[n]));
                  for (var o = g[i].style.cssText.split(";"), p = 0; p < o.length; p++) {
                    var q = o[p].trim()
                      .split(":")[0];
                    m[n].style[q] = b.window.getComputedStyle(m[n], null)
                      .getPropertyValue(q)
                  }
                }
            }
      ...
      var r = b.events.chainTrigger("html.get", d);
    ...
    function cleanWhiteTags(c) {
      ...
      do {
        ...
        for (var g = 0; g < e.length; g++) {
          ...
          0 === a(h)
            .find("*")
            .length && 1 === i.length && 8203 == i.charCodeAt(0) && (a(h)
            .remove(), f = !0)
        }
      } while (f)
    }
    ...
    function q(c) {
      ...
      for (var d = b.$el.find(b.html.blockTagsQuery())
        .andSelf()
        .not("TD, TH")
        .find(" > br"), e = 0; e < d.length; e++) {
        var f = d[e]
          , g = f.previousSibling
          , h = f.nextSibling
          , i = b.node.blockParent(f) || b.$el.get(0);
        g && i && "BR" != g.tagName && !b.node.isBlock(g) && !h && a(i)
          .text()
          .replace(/\u200B/g, "")
          .length > 0 && a(g)
          .text()
          .length > 0 && (b.selection.save(), a(f)
          .remove(), b.selection.restore())
      }
      var j = function (b) {
        if (!b) return !1;
    ...
    function d(c, d) {
      ...
      0 > e && (e = 0), e + b.$tooltip.outerWidth() > a(b.original_window)
        .width() && (e = a(b.original_window)
          .width() - b.$tooltip.outerWidth()), b.$tooltip.css("left", e), "undefined" == typeof d && (d = b.opts.toolbarBottom), b.$tooltip.css("top", d ? c.offset()
    ...
    function show(d, e, h, i) {
      if (areVisible() && b.$el.find(".fr-marker")
          .length > 0 && (b.events.disableBlur(), b.selection.restore()), hideAll([d]), !t[d]) return !1;
      ...
      b.opts.toolbarInline && l && b.$tb && l.get(0) == b.$tb.get(0) && (setContainer(d, b.opts.toolbarInline ? a(b.opts.scrollableContainer) : b.$box), h && (h = b.$tb.offset()
    ...
    function create(c, d) {
      ...
      b.opts.theme && g.addClass(b.opts.theme + "-theme"), b.opts.zIndex > 1 && b.$tb.css("z-index", b.opts.zIndex + 2), "auto" != b.opts.direction && g.removeClass("fr-ltr fr-rtl")
        .addClass("fr-" + b.opts.direction), g.find("input, textarea")
      ...
      return i.append(g), g.data("container", i), t[c] = g, b.button.bindCommands(g, !1), a(b.original_window)
        ...
        if (a.FroalaEditor.KEYCODE.ENTER == e) g.find(".fr-submit:visible")
          ...
          if (a.FroalaEditor.KEYCODE.ESC == e) return d.preventDefault(), d.stopPropagation()
            , b.$el.find(".fr-marker") && (b.events.disableBlur(), a(this)
            .data("skip", !0), b.selection.restore(), b.events.enableBlur()), f(c) && g.find(".fr-back:visible")
            .length ? b.button.exec(g.find(".fr-back:visible:first")) : hide(c), b.opts.toolbarInline && b.toolbar.showInline(null, !0), !1;
          d.stopPropagation()
        }
        ...
        if (a.FroalaEditor.KEYCODE.ESC == e) {
          if (f(c) && b.opts.toolbarInline) return d.stopPropagation(), f(c) && g.find(".fr-back:visible")
            .length ? b.button.exec(g.find(".fr-back:visible:first")) : (hide(c), b.toolbar.showInline(null, !0)), !1;
          f(c) && g.find(".fr-back:visible")
            .length ? b.button.exec(g.find(".fr-back:visible:first")) : hide(c)
        }
    ...
    function _init() {
      b.events.on("destroy", r, !0), b.events.on("window.mousedown", n), b.events.on("window.touchmove", o), b.events.on("mousedown", function (a) {
        areVisible() && b.$el.find(".fr-marker")
          .remove()
