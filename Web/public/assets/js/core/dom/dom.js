...
Dom.prototype.build = function () {
  ...
  this.progressbar.classList.add("mdl-cell--6-col");
  this.progressbar.classList.add("mdl-cell--3-offset");
  ...
  this.application.className = "mdl-layout mdl-js-layout mdl-layout--fixed-header";
...
// 
  ...
  this.leftPanel.className = "mdl-cell mdl-cell--2-col";
  this.grid.appendChild( this.leftPanel );

  this.content = document.createElement('div');
  this.content.className = "mdl-cell mdl-cell--8-col";
