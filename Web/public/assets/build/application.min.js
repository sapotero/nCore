...
/***/ function(module, exports, __webpack_require__) {
	...
	core = function () {
	  var Mediator = __webpack_require__(1),
	      ...
	      Element = __webpack_require__(8),
	      Polygon = __webpack_require__(27).default,
	      Draggy = __webpack_require__(28),
	      Shortcut = __webpack_require__(46),
	      Preloader = __webpack_require__(34),
	      Router = __webpack_require__(35),
	      Snackbar = __webpack_require__(37),
	      Templates = __webpack_require__(38),
	      Reports = __webpack_require__(39),
	      WebForms = __webpack_require__(40),
	      PrintForms = __webpack_require__(42),
	      User = __webpack_require__(43),
	      Bps = __webpack_require__(44);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Channel = function Channel(namespace, parent) {
...
/***/ function(module, exports) {
	...
	var Subscriber = function Subscriber(fn, options, context) {
...
/***/ function(module, exports) {
	...
	var WebWorker = function WebWorker() {
...
/***/ function(module, exports) {
	...
	var Base64 = function Base64(string) {
	  this.b64tab = {};
	...
	Base64.prototype.cb_utob = function (c) {
	  if (c.length < 2) {
	    ...
	    return cc < 0x80 ? c : cc < 0x800 ? this.fromCharCode(0xc0 | cc >>> 6) + this.fromCharCode(0x80 | cc & 0x3f) : this.fromCharCode(0xe0 | cc >>> 12 & 0x0f) + this.fromCharCode(0x80 | cc >>> 6 & 0x3f) + this.fromCharCode(0x80 | cc & 0x3f);
	  } else {
	    var cc = 0x10000 + (c.charCodeAt(0) - 0xD800) * 0x400 + (c.charCodeAt(1) - 0xDC00);

	    return this.fromCharCode(0xf0 | cc >>> 18 & 0x07) + this.fromCharCode(0x80 | cc >>> 12 & 0x3f) + this.fromCharCode(0x80 | cc >>> 6 & 0x3f) + this.fromCharCode(0x80 | cc & 0x3f);
	  }
	};
	...
	// decoder stuff
	Base64.prototype.re_btou = new RegExp(['[\xC0-\xDF][\x80-\xBF]', '[\xE0-\xEF][\x80-\xBF]{2}', '[\xF0-\xF7][\x80-\xBF]{3}'].join('|'), 'g');
	  ...
	  switch (cccc.length) {
	    case 4:
	      var cp = (0x07 & cccc.charCodeAt(0)) << 18 | (0x3f & cccc.charCodeAt(1)) << 12 | (0x3f & cccc.charCodeAt(2)) << 6 | 0x3f & cccc.charCodeAt(3),
	          offset = cp - 0x10000;
	      return this.fromCharCode((offset >>> 10) + 0xD800) + this.fromCharCode((offset & 0x3FF) + 0xDC00);
	    case 3:
	      return this.fromCharCode((0x0f & cccc.charCodeAt(0)) << 12 | (0x3f & cccc.charCodeAt(1)) << 6 | 0x3f & cccc.charCodeAt(2));
	    default:
	      return this.fromCharCode((0x1f & cccc.charCodeAt(0)) << 6 | 0x3f & cccc.charCodeAt(1));
	  }
	};
	...
	Base64.prototype.cb_decode = function (cccc) {
	  var len = cccc.length,
	      padlen = len % 4,
	      n = (len > 0 ? this.b64tab[cccc.charAt(0)] << 18 : 0) | (len > 1 ? this.b64tab[cccc.charAt(1)] << 12 : 0) | (len > 2 ? this.b64tab[cccc.charAt(2)] << 6 : 0) | (len > 3 ? this.b64tab[cccc.charAt(3)] : 0),
	      chars = [this.fromCharCode(n >>> 16), this.fromCharCode(n >>> 8 & 0xff), this.fromCharCode(n & 0xff)];
...
/***/ function(module, exports) {
	...
	Dom.prototype.createApplicationContent = function () {
	  ...
	  this.grid = core.elements.create({
	    ...
	    items: [this.leftPanel, this.content, this.infoPanel]
	  });
	...
	Dom.prototype.createProgressBar = function () {
	  ...
	  this.splashscreen = core.elements.create({
	    ...
	    items: [this.logo, this.progressbar]
	  });
	...
	Dom.prototype.createHeader = function () {
	  ...
	  this._title = core.elements.create({
	    ...
	    items: [this.subTitle, this.subTitleMenu]
	  });
	  ...
	  /*"mdl-layout--large-screen-only"*/this.headerSubMenu = core.elements.create({
	    elementType: 'simple',
	    class: ['mdl-navigation'],
	    items: [core.elements.create({
	      elementType: 'button',
	  ...
	  this.primaryHeader = core.elements.create({
	    ...
	    items: [this.title, core.elements.create({ elementType: 'spacer' }), this.navigation]
	  });

	  this.secondaryHeader = core.elements.create({
	    elementType: 'simple',
	    class: ["mdl-layout__header-row", "mdl-layout__header-row--secondary", "mdl-color--grey-50"],
	    items: [this._title, core.elements.create({ elementType: 'spacer' }), this.headerSubMenu]
	  });
	  ...
	  this.header = core.elements.create({
	    ...
	    items: [this.primaryHeader, this.secondaryHeader]
	  });
	...
	Dom.prototype.setUserName = function (user) {
	  ...
	  var user = core.elements.create({
	    ...
	    icon: 'person',
	    // fab         : true,
	    items: [{ text: user.name }, { text: user.provider.name }]
	  });
	...
	Dom.prototype.createDrawer = function () {
	  ...
	  this.drawer = core.elements.create({
	    ...
	    items: [this.drawerTitle, this.drawerNavigation]
	  });
...
/***/ function(module, exports, __webpack_require__) {
	...
	Element.prototype.Form = __webpack_require__(9);
	Element.prototype.Input = __webpack_require__(10);
	Element.prototype.Checkbox = __webpack_require__(11);
	Element.prototype.Radio = __webpack_require__(12);
	Element.prototype.Switch = __webpack_require__(13);
	Element.prototype.Textarea = __webpack_require__(14);
	Element.prototype.Label = __webpack_require__(15);

	Element.prototype.Select = __webpack_require__(16);
	Element.prototype.Search = __webpack_require__(17);
	Element.prototype.Dialog = __webpack_require__(18);

	Element.prototype.Simple = __webpack_require__(19);
	Element.prototype.Table = __webpack_require__(20);
	Element.prototype.Menu = __webpack_require__(21);
	Element.prototype.Icon = __webpack_require__(22);
	Element.prototype.Spacer = __webpack_require__(23);

	Element.prototype.Button = __webpack_require__(24);
	Element.prototype.List = __webpack_require__(25);
	Element.prototype.Card = __webpack_require__(26);
...
/***/ function(module, exports, __webpack_require__) {
	...
	Checkbox.prototype = Object.create(__webpack_require__(10).prototype);
...
/***/ function(module, exports, __webpack_require__) {
	...
	Radio.prototype = Object.create(__webpack_require__(10).prototype);
...
/***/ function(module, exports, __webpack_require__) {
	...
	Switch.prototype = Object.create(__webpack_require__(10).prototype);
...
/***/ function(module, exports) {
	...
	var Textarea = function Textarea(config) {
	  this.element = document.createElement('div');
...
/***/ function(module, exports, __webpack_require__) {
	...
	Dialog.prototype = Object.create(__webpack_require__(19).prototype);
...
/***/ function(module, exports, __webpack_require__) {
	...
	Table.prototype = Object.create(__webpack_require__(19).prototype);
...
/***/ function(module, exports, __webpack_require__) {
	...
	Menu.prototype = Object.create(__webpack_require__(19).prototype);
...
/***/ function(module, exports, __webpack_require__) {
	...
	Spacer.prototype = Object.create(__webpack_require__(19).prototype);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var RestrictionDecorator = __webpack_require__(29);
	var AxisDecorator = __webpack_require__(31);
	var SnapDecorator = __webpack_require__(32);
	var PositionDecorator = __webpack_require__(30);
	var Positions = __webpack_require__(33);

	var Drag = function Drag(el, config) {
	  var scope = this;
	  ...
	  this.Positions = new RestrictionDecorator(this.Positions, this.el, this.options.restrict);
	...
	var Draggy = function Draggy(config) {
	  this.elements = [];
	  this.active = {};
	  this.events = true;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var RestrictionDecorator = function RestrictionDecorator(Positions, el, restrictEl) {
	  ...
	  if (restrictEl == 'document') {
	    ...
	    if ((typeof restrictEl === 'undefined' ? 'undefined' : _typeof(restrictEl)) != 'object') {
	...
	RestrictionDecorator.prototype.getX = function () {
	  if (this.Positions.getX() < 0) {
	    return 0;
	  } else if (this.Positions.getX() > this.restrictWidth - this.el.offsetWidth) {
	...
	RestrictionDecorator.prototype.getY = function () {
	  if (this.Positions.getY() < 0) {
	    return 0;
	  } else if (this.Positions.getY() > this.restrictHeight - this.el.offsetHeight) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var AxisDecorator = function AxisDecorator(Positions) {
	  PositionDecorator.call(this, Positions);
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	var SnapDecorator = function SnapDecorator(Positions) {
	  PositionDecorator.call(this, Positions);
	};
	...
	SnapDecorator.prototype.getX = function () {
	  ...
	  return Math.round(this.Positions.getX() / snapX) * snapX;
	};
	SnapDecorator.prototype.getY = function () {
	  var snapY = this.Positions.getOptions().snapY;

	  return Math.round(this.Positions.getY() / snapY) * snapY;
	};
...
/***/ function(module, exports) {
	...
	var Positions = function Positions(options) {
	  this.options = options;
	  this.points = {
	    elementX: 0,
	    elementY: 0,
...
/***/ function(module, exports, __webpack_require__) {
	...
	WebForms.prototype.WebForm = __webpack_require__(41);
	...
	WebForms.prototype.renderInfoPanel = function (element) {
	  ...
	  if (element && element.hasOwnProperty('_conf')) {
	    ...
	    items.push(core.elements.create({
	      elementType: 'simple',
	      type: 'h3',
	      class: ['mdl-color-text--grey-400'],
	...
	WebForms.prototype.previewDialog = function (form) {
	  ...
	  minTop = Math.min.apply(Math, minTopArray);
	  minLeft = Math.min.apply(Math, minLeftArray);
	...
	WebForms.prototype.setSubTitleMenu = function () {
	  ...
	  var user2 = core.elements.create({
	    ...
	    text: 'print',
	    small: true,
	    items: [{ text: 'user.name', size: 10 }, { text: 'user.provider.name' }]
	  });

	  this.subTitleMenu = core.elements.create({
	    elementType: 'simple',
	    class: ['list__flex'],
	    items: [user, user1, user2]
	  });
	};
...
/***/ function(module, exports) {
	...
	var PrintFormSettings = function PrintFormSettings(config) {
	...
	var PrintForm = function PrintForm(config) {
	  this.element = {};
	  this._id = config._id || '';
	  this.name = config.name || '';
	  this.description = config.description || '';
	...
	var PrintForms = function PrintForms() {
	  this.element = {};
	  this.documents = {};
	  this.bindEvents();
	};
...
/***/ function(module, exports) {
	...
	var BusinessFormSettings = function BusinessFormSettings(config) {
	  this.current_date = new Date();
	  this.currentYear = this.current_date.getFullYear();
	  this.periodStart = this.current_date;
	  this.periodEnd = this.current_date;
	...
	var BusinessForm = function BusinessForm(config) {
	  this.element = {};
	  this._id = config._id || '';
	  this.name = config.name || '';
	  this.description = config.description || '';
	...
	var BusinessForms = function BusinessForms() {
	  this.element = {};
	  this.documents = {};
	  this.bindEvents();
	};
...
/***/ function(module, exports) {
	...
	var Shortcut = function Shortcut(options) {
	...
	Shortcut.prototype.setCallback = function (e) {
	  ...
	  if (keyPressedCounter == keys.length && this.modifiers.ctrl.pressed == this.modifiers.ctrl.wanted && this.modifiers.shift.pressed == this.modifiers.shift.wanted && this.modifiers.alt.pressed == this.modifiers.alt.wanted && this.modifiers.meta.pressed == this.modifiers.meta.wanted) {
	    this.callback(e);
